...
description: "InfoJobs DevBoard: React 19 SPA, Express REST API, flat JSON store, and a local Ollama service that streams AI-generated job summaries to the browser."
---
