...
description: "The InfoJobs DevBoard frontend is built with React 19, Vite 7, React Router DOM 7, and Zustand 5 — using lazy-loaded pages, protected routes, and CSS Modules."
---
